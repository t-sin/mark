...
lis_obj * _make_array() {
    ...
    arr->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_ARY << 4;
...
lis_obj * _make_string() {
    ...
    str->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_STR << 4;
...
lis_obj * _make_symbol(lis_obj * name) {
    ...
    sym->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_SYM << 4;
...
lis_obj * _make_cons() {
    ...
    cons->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_CONS << 4;
...
lis_obj * _make_package(lis_obj * name) {
    ...
    pkg->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_PKG << 4;
...
lis_obj * _make_env(env_type type) {
    ...
    env->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_ENV << 4;
...
lis_obj * _make_raw_function(lis_obj * (*raw_fn)(lis_obj *, lis_obj *)) {
    ...
    fn->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_FN << 4;
...
lis_obj * _make_lisp_closure(lis_lambdalist * lambdalist, lis_obj * body, lis_obj * lenv) {
    ...
    cls->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_CLS << 4;
...
lis_obj * _make_lis_stream(lis_stream * s) {
    ...
    stream->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_STRM << 4;
...
lis_obj * _make_error(lis_obj * msg) {
    ...
    err->tags = LIS_TAG2_BUILTIN << 2 | LIS_TAG_TYPE_ERR << 4;
